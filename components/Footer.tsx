...
const colHeading = "text-xs font-semibold uppercase tracking-widest text-neutral-400 dark:text-neutral-500";
const linkClass = "text-sm text-neutral-600 transition-colors hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100";
        ...
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed text-neutral-500 dark:text-neutral-400">
              Generate AI briefs for your next web project — structured, specific, and ready to paste.
            </p>
          </div>

          {/* Tools */}
          <div className="space-y-4">
            <h3 className={colHeading}>Tools</h3>
          ...
          {/* Navigate */}
          <div className="space-y-4">
            <h3 className={colHeading}>Navigate</h3>
            <ul className="space-y-2.5">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
          ...
          {/* Connect */}
          <div className="space-y-4">
            <h3 className={colHeading}>Connect</h3>
            <ul className="space-y-2.5">
              {SOCIAL_LINKS.map((s) => (
                <li key={s.label}>
                  <a
